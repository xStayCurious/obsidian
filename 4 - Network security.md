Logical security: [[Encryption - data in transit or at rest]], [[PKI]], [[IAM]], MFA, SSO, [[RADIUS]], [[LDAP]], [[SAML]], [[TACACS+]], [[time-based authentication]], [[authorization, least privilege, role-based access control, and geofencing]].
